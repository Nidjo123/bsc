...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/zadatak.jpg}
  \label{fig:zadatak}
\end{figure}

\zahvala{Zahvaljujem mentoru prof.~dr.~sc.~Siniši~Šegviću na pomoći pri izradi ovog rada
...
\kljucnerijeci{računalni vid, stereoskopska rekonstrukcija, poluglobalno podudaranje, disparitet, korespondencija, dinamičko programiranje}
\end{sazetak}
...
\keywords{computer vision, stereoscopic reconstruction, semi-global matching, disparity, correspondence, dynamic programming}
\end{abstract}
